...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        try{
            ...
            if(item.getProduct().getAvail() + oldQuant < quant){
             JOptionPane.showMessageDialog(this, "Please check the Product availabiltiy");
             return;
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if(salesPrice < product.getPrice()){
             ...
             JOptionPane.showMessageDialog(this, "Price you enter should be more than it is set in the price");
             return;
        }
    ...
    private void populateProductTable() {
        ...
        Supplier slectedSupplier = (Supplier) cmbSupplier.getSelectedItem();

        if (slectedSupplier == null) {
            return;
        }
        DefaultTableModel model = (DefaultTableModel) tblProductCatalog.getModel();
        model.setRowCount(0);

        for (Product p : slectedSupplier.getProductCatalog().getProductcatalog()) {
